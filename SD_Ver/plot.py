...
def draw_heatmap(data, row_labels, column_labels,savepath):
    ...
    # sns.heatmap(data,annot=True,fmt="1.0f",vmin=0, vmax=1000, cmap='Blues',linewidths=0.5,linecolor='black',)
    sns.heatmap(data,vmin=0, vmax=1000, cmap='Blues',mask=mask)
